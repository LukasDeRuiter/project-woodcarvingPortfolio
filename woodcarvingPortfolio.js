...
let _imageTitle = document.getElementById('imageTitleID'); // this variable is used to put my woodcarvingmodels name and year of creation above the image
    ...
    document.querySelectorAll(".humanModels").forEach(humanModels => humanModels.addEventListener('click', function(event){
        ...
        switch(chosenModel){
            case 1:
                ...
                _imageTitle.innerHTML = "First female human figure (created in 2020)";
                break;
            case 2:
                imgOnScreen.src = "images/figures/figure2pic1.jpg";
                _imageTitle.innerHTML = "Second female human figure (created in 2020)";
                break;
            case 3:
                imgOnScreen.src = "images/figures/figure3pic1.jpg";
                _imageTitle.innerHTML = "First male human figure (created in 2020)";
                break;
            case 4:
                imgOnScreen.src = "images/figures/figure4pic1.jpg";
                _imageTitle.innerHTML = "Female Hoplite (created in 2021)";
                break;
            case 5:
                imgOnScreen.src = "images/figures/figure5pic1.jpg";
                _imageTitle.innerHTML = "Female angelic figure with Chakhra's (created in 2020)";
                break;
            case 6:
                imgOnScreen.src = "images/figures/figure6pic1.jpg";
                _imageTitle.innerHTML = "Skelliman (created in 2020)";
                break;
            case 7:
                imgOnScreen.src = "images/figures/figure7pic1.jpg";
                _imageTitle.innerHTML = "Female archer (created in 2020)";
                break;
            case 8:
                imgOnScreen.src = "images/figures/figure8pic1.jpg";
                _imageTitle.innerHTML = "Oscar of Astora with Halberd (Dark Souls, created in 2020)";
                break;
    }
    }))
    ...
    document.querySelectorAll(".animalModels").forEach(animalModels => animalModels.addEventListener('click', function(event){
        ...
        switch(chosenModel){
            case 9:
                ...
                _imageTitle.innerHTML = "Big armadillo (created in 2019)";
                break;
            case 10:
                imgOnScreen.src = "images/figures/figure10pic1.jpg";
                _imageTitle.innerHTML = "Tarantula (created in 2019/2020)";
                break;
            case 11:
    ...
    document.querySelectorAll(".wowModels").forEach(wowModels => wowModels.addEventListener('click', function(event){
        ...
        switch(chosenModel){
            case 25:
                ...
                _imageTitle.innerHTML = "My main character, Speedhoven (created in 2019)";
                break;
            case 26:
                imgOnScreen.src = "images/figures/figure26pic1.jpg";
                _imageTitle.innerHTML = "Fox mount (created in 2019)";
                break;
            case 27:
                imgOnScreen.src = "images/figures/figure27pic1.jpg";
                _imageTitle.innerHTML = "Armored Mammoth (created in 2020)";
                break;
            case 28:
                imgOnScreen.src = "images/figures/figure28pic1.jpg";
                _imageTitle.innerHTML = "Armored war kodo (created in 2021)";
                break;
            case 29:
                imgOnScreen.src = "images/figures/figure29pic1.jpg";
                _imageTitle.innerHTML = "Goren (created in 2018)";
                break;
            case 30:
                imgOnScreen.src = "images/figures/figure30pic1.jpg";
                _imageTitle.innerHTML = "Core Hound (created in 2018 in the U.S.A)";
                break;
            case 31:
    ...
    document.querySelectorAll(".pokemonModels").forEach(pokemonModels => pokemonModels.addEventListener('click', function(event){
        ...
        switch(chosenModel){
            case 33:
                ...
                _imageTitle.innerHTML = "Squirtle (created in 2018 in the U.S.A)";
                break;
            case 34:
                imgOnScreen.src = "images/figures/figure34pic1.jpg";
                _imageTitle.innerHTML = "Bulbasaur (created in 2018 in the U.S.A)";
                break;
            case 35:
                imgOnScreen.src = "images/figures/figure35pic1.jpg";
                _imageTitle.innerHTML = "Charmander (created in 2018 in the U.S.A)";
                break;
            case 36:
                imgOnScreen.src = "images/figures/figure36pic1.jpg";
                _imageTitle.innerHTML = "Aaron (created in 2018)";
                break;
            case 37:
                imgOnScreen.src = "images/figures/figure37pic1.jpg";
                _imageTitle.innerHTML = "Lairon (created in 2018)";
                break;
            case 38:
                imgOnScreen.src = "images/figures/figure38pic1.jpg";
                _imageTitle.innerHTML = "Golem (created in 2020)";
                break;
            case 39:
                imgOnScreen.src = "images/figures/figure39pic1.jpg";
                _imageTitle.innerHTML = "Lotad (created in 2019)";
                break;
            case 40:
    ...
    document.querySelectorAll(".zeldaModels").forEach(zeldaModels => zeldaModels.addEventListener('click', function(event){
        ...
        switch(chosenModel){
            case 41:
                ...
                _imageTitle.innerHTML = "Skull Kid With Majora's mask (created in 2019)";
                break;
            case 42:
                imgOnScreen.src = "images/figures/figure42pic1.jpg";
                _imageTitle.innerHTML = "Redead (created in 2018)";
                break;
            case 43:
                imgOnScreen.src = "images/figures/figure43pic1.jpg";
                _imageTitle.innerHTML = "Deku Link (created in 2018)";
                break;
            case 44:
                imgOnScreen.src = "images/figures/figure44pic1.jpg";
                _imageTitle.innerHTML = "King Dodongo (created in 2019)";
                break;
            case 45:
                imgOnScreen.src = "images/figures/figure45pic1.jpg";
                _imageTitle.innerHTML = "Garo (created in 2019)";
                break;
            case 46:
    ...
    document.querySelectorAll(".runescapeModels").forEach(runescapeModels => runescapeModels.addEventListener('click', function(event){
        ...
        switch(chosenModel){
            case 49:
                ...
                _imageTitle.innerHTML = "Full Helmet and kiteshield (created in 2018)";
                break;
            case 50:
    ...
    document.querySelectorAll(".otherModels").forEach(otherModels => otherModels.addEventListener('click', function(event){
        ...
        switch(chosenModel){
            case 57:
                ...
                _imageTitle.innerHTML = "Shellyman (created in 2020)";
                break;
            case 58:
                imgOnScreen.src = "images/figures/figure58pic1.jpg";
                _imageTitle.innerHTML = "Gobbler (created in 2019)";
                break;
            case 59:
    ...
    document.querySelectorAll(".human2Models").forEach(human2Models => human2Models.addEventListener('click', function(event){
        ...
        switch(chosenModel){
            case 65:
                ...
                _imageTitle.innerHTML = "Viking (created in 2018)";
                break;
            case 66:
                imgOnScreen.src = "images/figures/figure66pic1.jpg";
                _imageTitle.innerHTML = "Warhammer dwarf(created in 2021)";
                break;
            case 67:
